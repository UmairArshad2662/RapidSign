      ...
      >
        <CardContent className="text-muted-foreground/40 flex flex-col items-center justify-center p-6">
          {disabled ? (
            ...
            <div className="flex">
            <motion.div
              className="z-10 flex aspect-[3/4] w-24 origin-top-right -rotate-[22deg] flex-col gap-y-1 rounded-lg border border-muted-foreground/20 bg-transparent px-2 py-4 backdrop-blur-sm group-hover:bg-gradient-to-b group-hover:from-[#CE52FA] group-hover:to-[#64009F] group-hover:border-transparent"
              variants={DocumentDropzoneCardLeftVariants}
            >
              <div className="bg-muted-foreground/20 group-hover:bg-white h-2 w-full rounded-[2px]" />
              <div className="bg-muted-foreground/20 group-hover:bg-white h-2 w-5/6 rounded-[2px]" />
              <div className="bg-muted-foreground/20 group-hover:bg-white h-2 w-full rounded-[2px]" />
            </motion.div>
          
            <motion.div
              className="z-20 flex aspect-[3/4] w-24 flex-col items-center justify-center gap-y-1 rounded-lg border border-muted-foreground/20 bg-transparent px-2 py-4 backdrop-blur-sm group-hover:bg-gradient-to-b group-hover:from-[#CE52FA] group-hover:to-[#64009F] group-hover:border-transparent"
              variants={DocumentDropzoneCardCenterVariants}
            >
              <Plus
                strokeWidth="2px"
                className="text-muted-foreground/20 group-hover:text-white h-12 w-12"
              />
            </motion.div>
          
            <motion.div
              className="z-10 flex aspect-[3/4] w-24 origin-top-left rotate-[22deg] flex-col gap-y-1 rounded-lg border border-muted-foreground/20 bg-transparent px-2 py-4 backdrop-blur-sm group-hover:bg-gradient-to-b group-hover:from-[#CE52FA] group-hover:to-[#64009F] group-hover:border-transparent"
