...
export function generateMetadata() {
  return {
    ...
    openGraph: {
      title: 'Rapid Sign - The Open Source DocuSign Alternative',
      description:
        'Join Rapid Sign, the open signing infrastructure, and get a 10x better signing experience. Pricing starts at $30/mo. forever! Sign in now and enjoy a faster, smarter, and more beautiful document signing process. Integrates with your favorite tools, customizable, and expandable. Support our mission and become a part of our open-source community.',
      type: 'website',
